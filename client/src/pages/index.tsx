...
export default function Home({ poolCount, guessCount, userCount }: HomeProps) {
  ...
  return (
    ...
    <Head>
      ...
      <div
        className="max-w-[1124px] h-screen mx-auto grid grid-cols-2
      gap-28 items-center m-20"
      >
        <main>
          ...
          <form onSubmit={createPool} className="mt-10 flex gap-2">
            <input
              className="flex-1 px-6 py-4 rounded bg-gray-800 border border-gray-600 text-sm outline-none text-white"
              type="text"
              required
